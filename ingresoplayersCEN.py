...
def ejecutar_ingresoCEN(master_frame, callback_volver):
    ...
    def guardar_datos():
        ...
        nombres_existentes = []
        try:
            with open("players.txtCEN", "r") as f:
                for linea in f:
        ...
        # --- GUARDAR ---
        with open("players.txtCEN", "a") as f:
        ...
        # Opcional: Resetear los personajes secundarios a vacío
        combo_sub1.set("")
        combo_sub2.set("")
