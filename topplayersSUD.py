...
def generar_ranking_imagen():
    jugadores = []

    # 1. LEER DATOS
    try:
        with open("players.txt", "r") as archivo:
        ...
        print("Error: No se encuentra players.txt")
        return
    ...
    try:
        template_path = obtener_ruta("archivos/template.jpg")
        ...
        # Coordenadas IMPORTANTE SIEMPRE QUE SE QUIERAN EDITAR 
        ...
        ruta_guardado = filedialog.asksaveasfilename(
            ...
            initialfile="CarnivalSUDTop10.png"
        )
